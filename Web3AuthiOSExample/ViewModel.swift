...
//        Task.detached { [unowned self] in
//            do {
//                web3Auth = await Web3Auth(W3AInitParams(clientId: clientId, network: network, whiteLabel: W3AWhiteLabelData(name: "Web3Auth Stub", dark: true, theme: ["primary": "#123456"])))
